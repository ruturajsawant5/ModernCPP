...
int main()
{
    ...
    //int *&p_ref1 = ptr1 ; //error: binding reference of type ‘int*&’ to ‘const int*’ discards qualifiers
    //const int*&p_ref2 = ptr2 ; //error: binding reference of type ‘int*&’ to ‘const int*’ discards qualifiers
